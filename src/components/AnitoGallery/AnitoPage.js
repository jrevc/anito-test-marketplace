            ...
            <div className="anito-page-right">
                ...
                <div className="anito-page-details">
                    <div className="anito-page-details-left">
                        <h1>{anito.name}</h1>
                        <AnitoClassLabel className="anito-page-class" anitoClass={className}>
                ...
                <div className="anito-page-stats">
                    ...
                    <div className="stat-display">
                        ...
                        <div className="stat-display-graphics">
                            <div className="stat-number">
                                <img src={process.env.PUBLIC_URL + '/images/sword_gray.png'} alt="Sword icon" />
                                Attack
                            </div>
                    ...
                    <div className="stat-display">
                        ...
                        <div className="stat-display-graphics">
                            <div className="stat-number">
                                <img src={process.env.PUBLIC_URL + '/images/heart_gray.png'} alt="Heart icon" />
                                Hit Points
                            </div>
                            <div className="stat-display-graph">
                                <div className="stat-bar">
                    ...
                    <div className="stat-display">
                        ...
                        <div className="stat-display-graphics">
                            <div className="stat-number">
                                <img src={process.env.PUBLIC_URL + '/images/shield_gray.png'} alt="Shield icon" />
                                Defense
                            </div>
                            <div className="stat-display-graph">
                                <div className="stat-bar">
