...
const AnitoFilter = (props) => {
    ...
    const onClassFilterChange = (event, atk = atkFilter, hp = HPFilter, def = defFilter) => {
        ...
        let filteredList = classList.filter((anitoClass) => anitoClass.checked).map((anitoClass) => anitoClass.value);
        if (filteredList.length <= 0) {
            filteredList = classList.map((anitoClass) => anitoClass.value);
        }
            ...
            <div className="filter-container">
                <div className="filter-section">
                    ...
                    <div className="filter-class">
                        ...
                        <AnitoClassLabel
                            anitoClass="kiwig"
                            className="filter-class-label filter-checkbox-label"
                            labelTarget="filter-kiwig"
                        >
                            Kiwig
                        </AnitoClassLabel>
                    </div>
                    ...
                    <div className="filter-class">
                        ...
                        ></input>
                        <AnitoClassLabel
                            anitoClass="tikbalang"
                            className="filter-class-label filter-checkbox-label"
                            labelTarget="filter-tikbalang"
                        >
                            Tikbalang
                        </AnitoClassLabel>
                    </div>
